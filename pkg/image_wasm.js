...
export class ImageProcessor {
     ...
     */
    to_bytes() {
        const ret = wasm.imageprocessor_to_bytes(this.__wbg_ptr);
    ...
    adjust_brightness(value) {
        wasm.imageprocessor_adjust_brightness(this.__wbg_ptr, value);
    }
    /**
     * @param {number} contrast
     */
    adjust_contrast(contrast) {
        wasm.imageprocessor_adjust_contrast(this.__wbg_ptr, contrast);
    }
    /**
     * @param {number} sigma
     */
    blur(sigma) {
        wasm.imageprocessor_blur(this.__wbg_ptr, sigma);
    }
    /**
     * @param {number} sigma
    ...
    sharpen(sigma, threshold) {
        wasm.imageprocessor_sharpen(this.__wbg_ptr, sigma, threshold);
    }
    detect_edges() {
        wasm.imageprocessor_detect_edges(this.__wbg_ptr);
    }
    /**
     ...
     * @returns {Uint8Array}
     */
    generate_thumbnail(max_width, max_height) {
        const ret = wasm.imageprocessor_generate_thumbnail(this.__wbg_ptr, max_width, max_height);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
